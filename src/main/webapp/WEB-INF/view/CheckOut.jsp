...
<div id="heading">
	...
	<div class="row">
		...
		<form action="/AntiqueGalleryFrontEnd/order/invoice" method="POST">
						...
						<div class="paymentWrap">
							<div class="btn-group paymentBtnGroup btn-group-justified" data-toggle="buttons">
					            ...
					            <label class="btn paymentMethod">
					                ...
					                <input type="radio" name="options" value="ez-cash"> 
					            </label>
					         
					        </div>        
						</div>
						<div class="footerNavWrap clearfix">
							<input class="btn btn-success pull-right btn-fyi" type="submit" name="NEXT" value="NEXT">
							...
							<%-- <div class="btn btn-success pull-right btn-fyi"><center><a href="/AntiqueGalleryFrontEnd/order/invoice" id="cs">NEXT</a></center><span class="glyphicon glyphicon-chevron-right"></span></div> --%>
						</div>
						</form>
					</div>
